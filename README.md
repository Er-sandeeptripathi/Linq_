...
<connectionStrings>
  <add name="constr" connectionString="Data Source=.;Initial Catalog=YourDB;Integrated Security=True"/>
</connectionStrings>
 ...
 protected void ddlState_SelectedIndexChanged(object sender, EventArgs e)
{
    ...
    else if (ddlState.SelectedValue == "UP")
    {
        ddlCity.Items.Clear();
